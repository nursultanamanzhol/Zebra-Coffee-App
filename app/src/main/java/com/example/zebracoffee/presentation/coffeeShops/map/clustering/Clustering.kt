...
import com.example.zebracoffee.presentation.coffeeShops.map.clustering.library.GoogleMapComposable
import com.example.zebracoffee.presentation.coffeeShops.map.clustering.library.InputHandler
import com.example.zebracoffee.presentation.coffeeShops.map.clustering.library.MapEffect
import com.example.zebracoffee.presentation.coffeeShops.map.clustering.library.MapsComposeExperimentalApi
import com.example.zebracoffee.presentation.coffeeShops.map.clustering.library.currentCameraPositionState
import com.example.zebracoffee.presentation.coffeeShops.map.clustering.library.rememberComposeUiViewRenderer
import com.example.zebracoffee.presentation.coffeeShops.map.clustering.library.rememberReattachClickListenersHandle
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        """,
        imports = [
            "com.example.zebracoffee.presentation.coffeeShops.map.clustering.Clustering",
